...
export default function BookingFlow({ tour, onBooked, size = "sm" }) {
  ...
  // Detecta si hay un usuario logeado y precarga sus datos; también
  // se mantiene sincronizado si el estado de sesión cambia (ej. tras
  // volver del login con Google)
  useEffect(() => {
      ...
      {sheetStep && (
        ...
        >
          ...
          <div className="p-5 overflow-y-auto overscroll-contain flex-1 pb-safe">
            ...
            {sheetStep === "personas" &&
              (() => {
                // 🟢 AHORA (Dinámico directamente de la RPC)
                const maxPlazas = selectedSlot?.remaining ?? 0;
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <button
                            ...
                            disabled={
                              totalPersonas >= maxPlazas || maxPlazas <= 0
                            }
                          >
                            +
                          </button>
                  ...
                  <div className="flex-1 w-full max-w-md mx-auto px-6 py-4 flex flex-col">
                    ...
                    <div className="flex flex-col gap-5">
                      ...
                      <button
                        ...
                        disabled={
                          submitting || (!user && (!customerName || !email))
                        }
